...
5.  **Add Project Cursor Rule:**
    To optimize the agent's behavior with Domino, create a cursor rule file in your datascience project:
    
    Create a file at `.cursor/rules/domino-project-rule.mdc` in your project root and add the following content:
    ```
    ...
    **Important:** Set this rule to "Always" in Cursor's rule settings to ensure it's consistently applied.
