...
The domino project name and user name are available in a file called domino_project_settings.md which needs to be used in most tool calls by the agentic assistant. If this file does not exist do not include values for username and project
